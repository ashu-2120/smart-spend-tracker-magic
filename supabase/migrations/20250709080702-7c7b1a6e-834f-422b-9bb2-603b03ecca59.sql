...
-- Create functions for user_settings operations
...
AS $$
  ...
  DO UPDATE SET 
    ...
    updated_at = now()
  RETURNING user_settings.id, user_settings.user_id, user_settings.currency, 
            user_settings.monthly_budget, user_settings.theme, 
            user_settings.notifications_enabled, user_settings.budget_alerts;
$$;