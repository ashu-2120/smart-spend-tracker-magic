...
const DashboardExpenseAnalyser = () => {
  const { user } = useAuth();
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      <div className="mb-8">
        <h1 className="text-3xl font-bold text-gray-900 mb-2">Expense Analyser</h1>
        <p className="text-gray-600">Advanced analysis and insights into your spending patterns</p>
      </div>
      ...
      <Card className="mb-6">
        <CardHeader>
          ...
          <CardDescription>Customize your analysis by selecting date ranges and filters</CardDescription>
        </CardHeader>
        <CardContent>
      ...
      {categoryData.length > 0 ? (
        <>
          ...
          {monthlyTrend.length > 0 && (
            <Card className="mb-8">
              <CardHeader>
                ...
                <CardDescription>Your spending pattern over the selected period</CardDescription>
              </CardHeader>
              <CardContent>
                <ResponsiveContainer width="100%" height={300}>
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>Detailed breakdown by category with insights</CardDescription>
            </CardHeader>
            <CardContent>
        ...
        <Card>
          <CardContent className="text-center py-8">
            ...
            <p className="text-sm text-gray-500 mt-2">Try adjusting your date range or add some expenses to see analysis.</p>
          </CardContent>
        </Card>
      )}
    </div>
...
export default DashboardExpenseAnalyser;
